...
//   MUTATE_PACKAGE=session npm run test:mutation  mutate just that package
//
...
export default {
	...
	testRunner: "command",
	commandRunner: {
		command: `node --test --test-concurrency 1 ./${base}/**/*.test.js`,
	},
	...
	tempDirName: pkg ? `/tmp/stryker/@1auth/${pkg}` : "/tmp/stryker/@1auth",
};
