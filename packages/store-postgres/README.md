<div align="center">
  <h1>@1auth/store-postgres</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>PostgreSQL storage implementation for relational database persistence</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/store-postgres"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/store-postgres.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/store-postgres"><img src="https://packagephobia.com/badge?p=@1auth/store-postgres" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-postgres">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/store-postgres.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-postgres#provenance">
...
```bash
npm install @1auth/store-postgres
```
