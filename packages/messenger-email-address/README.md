<div align="center">
  <h1>@1auth/messenger-email-address</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>Email address messenger for email verification and notifications</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/messenger-email-address"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/messenger-email-address.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/messenger-email-address"><img src="https://packagephobia.com/badge?p=@1auth/messenger-email-address" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/messenger-email-address">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/messenger-email-address.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/messenger-email-address#provenance">
...
```bash
npm install @1auth/messenger-email-address
```
