<div align="center">
  <h1>@1auth/session-dbsc</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>Device Bound Session Credentials (DBSC) for @1auth/session</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/session-dbsc"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/session-dbsc.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/session-dbsc"><img src="https://packagephobia.com/badge?p=@1auth/session-dbsc" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/session-dbsc">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/session-dbsc.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/session-dbsc#provenance">
...
```bash
npm install @1auth/session-dbsc
```
