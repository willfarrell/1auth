<div align="center">
  <h1>@1auth/store-d1</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>Cloudflare D1 storage implementation for serverless SQLite persistence</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/store-d1"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/store-d1.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/store-d1"><img src="https://packagephobia.com/badge?p=@1auth/store-d1" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-d1">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/store-d1.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-d1#provenance">
