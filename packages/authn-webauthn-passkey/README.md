...
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-passkey"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/authn-webauthn-passkey.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/authn-webauthn-passkey"><img src="https://packagephobia.com/badge?p=@1auth/authn-webauthn-passkey" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-passkey">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/authn-webauthn-passkey.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-passkey#provenance">
...
```bash
npm install @1auth/authn-webauthn-passkey
```
