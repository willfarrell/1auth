<div align="center">
  <h1>@1auth/authn-webauthn-securitykey</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>SecurityKey preset for @1auth/authn-webauthn</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-securitykey"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/authn-webauthn-securitykey.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/authn-webauthn-securitykey"><img src="https://packagephobia.com/badge?p=@1auth/authn-webauthn-securitykey" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-securitykey">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/authn-webauthn-securitykey.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-webauthn-securitykey#provenance">
...
```bash
npm install @1auth/authn-webauthn-securitykey
```
