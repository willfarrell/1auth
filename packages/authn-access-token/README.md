<div align="center">
  <h1>@1auth/authn-access-token</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>Access token authentication for API and service-to-service communication</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/authn-access-token"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/authn-access-token.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/authn-access-token"><img src="https://packagephobia.com/badge?p=@1auth/authn-access-token" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-access-token">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/authn-access-token.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/authn-access-token#provenance">
...
```bash
npm install @1auth/authn-access-token
```
