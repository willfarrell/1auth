<div align="center">
  <h1>@1auth/store-sql</h1>
  <!--<img alt="1auth logo" src="https://raw.githubusercontent.com/willfarrell/1auth/main/docs/img/logo.svg"/>-->
  <p><strong>Generic SQL storage implementation for any client exposing a query method</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@1auth/store-sql"><img alt="npm version" src="https://img.shields.io/npm/v/@1auth/store-sql.svg"></a>
  <a href="https://packagephobia.com/result?p=@1auth/store-sql"><img src="https://packagephobia.com/badge?p=@1auth/store-sql" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-sql">
  <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@1auth/store-sql.svg"></a>
  <a href="https://www.npmjs.com/package/@1auth/store-sql#provenance">
